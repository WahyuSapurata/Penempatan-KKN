...
@php
    $disabled = in_array($kriteria->nama_kriteria, ['Jenis Kelamin', 'Fakultas', 'Jurusan']) ? 'disabled' : '';
@endphp
@section('button')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
            ...
            <!--begin::Title-->
            <button class="btn btn-info btn-sm {{ $disabled }}" data-kt-drawer-show="true"
        ...
        <div class="card w-100">
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="uuid_kriteria" value="{{ $kriteria->uuid }}">
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Sub Kriteria');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/sub-kriteria-add', 'Tambah',
                    'Sub Kriteria',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/sub-kriteria-edit/' + uuid,
                    'Update',
                    'Sub Kriteria', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/sub-kriteria-show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Sub Kriteria', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/sub-kriteria-delete/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/admin/sub-kriteria-get/' + '{{ $kriteria->uuid }}',
                columns: [{
                    data: null,
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Sub Kriteria" class="btn btn-danger button-delete btn-icon btn-sm {{ $disabled }}">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
